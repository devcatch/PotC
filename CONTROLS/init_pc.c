...
void ExternControlsInit(bool bFirst)
{
	...
	CI_CreateAndSetControls( "", "TimeScale", CI_GetKeyCode("KEY_V"), 0, false );
    // boal -->
...
    CI_CreateAndSetControls( "", "TimeScaleSlower", CI_GetKeyCode("VK_SUBTRACT"), 0, false ); //Tyrus
    ...
    CI_CreateAndSetControls( "", "BI_ChargeGrapes", CI_GetKeyCode("KEY_2"), 0, false );
    CI_CreateAndSetControls( "", "BI_ChargeKnippels", CI_GetKeyCode("KEY_3"), 0, false );
    CI_CreateAndSetControls( "", "BI_ChargeBombs", CI_GetKeyCode("KEY_4"), 0, false );
    ...
    CI_CreateAndSetControls( "", "BOAL_UsePotion", CI_GetKeyCode("KEY_C"), 0, false );
    // boal <--
    /*
	// Cameras =====================================================================
		// character camera
	CI_CreateAndSetControls( "", "ChrCamTurnV", 257, INVERSE_CONTROL, false );  // boal INVERSE_CONTROL
	...
	CI_CreateAndSetControls( "PrimaryLand", "ChrCamCameraSwitch", CI_GetKeyCode("VK_TAB"), 0, true );
		...
		// ship follow camera
	CI_CreateAndSetControls( "", "ShipCamera_Turn_V", 257, 0, false ); // boal INVERSE_CONTROL
	...
	CI_CreateAndSetControls( "Sailing3Pers", "ShipCamera_Backward", CI_GetKeyCode("VK_RBUTTON"), 0, true );
		...
		// deck camera
	CI_CreateAndSetControls( "", "DeckCamera_Turn_V", 257, INVERSE_CONTROL, false );//boal  INVERSE_CONTROL
	...
	//CI_CreateAndSetControls( "Sailing1Pers", "DeckCamera_Right", CI_GetKeyCode("VK_RIGHT"), 0, true );
		...
		// free camera
	CI_CreateAndSetControls( "", "FreeCamera_Turn_V", 257, INVERSE_CONTROL, false ); // boal  INVERSE_CONTROL
