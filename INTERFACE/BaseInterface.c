...
{
	questTextFileName[0] = "resource\queststext\quests_texts.txt";
	questTextFileName[1] = "";
...
// boal <--
// boal 29.08 debug info -->
    Interfaces[INTERFACE_BOAL_DEBUG].SectionName = "interface\boal_debug.c";
	Interfaces[INTERFACE_BOAL_DEBUG].IniFile = "RESOURCE\INI\INTERFACES\boal_debug.ini";
// boal <--
